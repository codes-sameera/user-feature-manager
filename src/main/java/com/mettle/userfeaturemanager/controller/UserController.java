...
import com.mettle.userfeaturemanager.model.communication.Status;
...
public class UserController {
    ...
    public Status addFeatures(@PathVariable Long userid, @RequestBody FeatureUpdatingInfo featureUpdatingInfo) {
        return userService.updateFeatures(userid, featureUpdatingInfo);
    }

    @PreAuthorize("hasAuthority('ADMIN')")
    @PatchMapping("/{userid}/role")
    public Status updateRole(@PathVariable Long userid, @RequestBody RoleUpdatingInfo roleUpdatingInfo) {
